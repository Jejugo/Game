 ...
 * @author JeffGoes
 */
public class Fase2 extends javax.swing.JFrame implements MouseListener, KeyListener {

    private Fogo fogao;
    private MonstroRosa lado;
    private MonstroRosaVertical frente;
    ...
    public Fase2(int vidas, int de_onde_vem, boolean cora1, boolean cora2, boolean cora3, boolean cora4, boolean pegouperola, boolean pegoubichovaivemhorizontal1) {
        this.vidas = vidas;
        this.cora1 = cora1;
        this.cora2 = cora2;
        this.cora3 = cora3;
        ...
        LoloSingleton.getInstance("lolo.png").setPosicao(10, 6);
        ...
        if (de_onde_vem == 1) {
            ...
            lado = new MonstroRosa("monstrorosalado.png", this);
            lado.setPosicao(9, 1);
            this.addElemento(lado);

            frente = new MonstroRosaVertical("monstrorosafrente.png", this);
            frente.setPosicao(1, 4);
            this.addElemento(frente);
        } else {
            if (cora1 == false) {
                Coracao coracao1 = new Coracao("coracao2.png");
                coracao1.setPosicao(2, 2);
    ...
    public void paint(Graphics gOld) {
        ...
        try {
            ...
            g2.drawImage(ponte, 5 * Consts.CELL_SIDE, 4 * Consts.CELL_SIDE, Consts.CELL_SIDE, Consts.CELL_SIDE, null);
            g2.drawImage(ponte, 10 * Consts.CELL_SIDE, 4 * Consts.CELL_SIDE, Consts.CELL_SIDE, Consts.CELL_SIDE, null);
            g2.drawImage(ponte, 5 * Consts.CELL_SIDE, 5 * Consts.CELL_SIDE, Consts.CELL_SIDE, Consts.CELL_SIDE, null);
            g2.drawImage(ponte, 10 * Consts.CELL_SIDE, 5 * Consts.CELL_SIDE, Consts.CELL_SIDE, Consts.CELL_SIDE, null);
            ...
            Intransponivel caixinhaVerde = new Intransponivel("caixinhaverde.png");
            caixinhaVerde.setPosicao(10, 7);
            this.addElemento(caixinhaVerde);
            ...
            if (pegouperola == true) {
                ...
                this.removeElemento(lado);//remove a o montro rosa do lado
                this.removeElemento(frente); //remove o monstro rosa da frente
            }
    ...
    public void auto_save(){
        TimerTask task = new TimerTask() {
            ...
            public void run() {
                cg.autosalvar_fase2(vidas, 2, cora1, cora2, cora3, cora4, pegouperola, pegoubichovaivemhorizontal1);
            }
    ...
    public void keyPressed(KeyEvent e) {
        if(e.getKeyCode() == KeyEvent.VK_S){
             ...
             cg.salvar_fase2(vidas, 2, cora1, cora2, cora3, cora4, pegouperola, pegoubichovaivemhorizontal1);
        }
        ...
        if (LoloSingleton.getInstance("lolo.png").getPosicao().getColuna() == 10 && LoloSingleton.getInstance("lolo.png").getPosicao().getLinha() == 2) {
            if (cora2 == false) {
                cora2 = true;
            }
        }
        if (LoloSingleton.getInstance("lolo.png").getPosicao().getColuna() == 8 && LoloSingleton.getInstance("lolo.png").getPosicao().getLinha() == 9) {
            if (cora3 == false) {
                cora3 = true;
            }
        }
        if (LoloSingleton.getInstance("lolo.png").getPosicao().getColuna() == 1 && LoloSingleton.getInstance("lolo.png").getPosicao().getLinha() == 11) {
            if (cora4 == false) {
                cora4 = true;
            }
        }
        if (this.cora1 == true && this.cora2 == true && this.cora3 == true && this.cora4 == true) {
            repaint();
            if (LoloSingleton.getInstance("lolo.png").getPosicao().getColuna() == 1 && LoloSingleton.getInstance("lolo.png").getPosicao().getLinha() == 6) {
                if (pegouperola == false) {
                    pegouperola = true;
                }
            }
        ...
        if (pegouperola == true) {
            ...
            pt1.setPosicao(0, 10);
            this.addElemento(pt1);
            if (LoloSingleton.getInstance("lolo.png").getPosicao().getColuna() == 10 && LoloSingleton.getInstance("lolo.png").getPosicao().getLinha() == 1) {
                java.awt.EventQueue.invokeLater(new Runnable() {
                    public void run() {
                        sair();
